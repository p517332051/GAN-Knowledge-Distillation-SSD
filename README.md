...
| Student net                                             | Teacher net            | Pascal Voc 2007 test        |
| :------------------------------------------------------ | :--------------------- | --------------------------- |
| ResNet50+roipooling（with GAN-KD and cosine attention） | -<br />ResNet101<br /> | 67.0<br />73.8+(+6.8)<br /> |
| ResNet50+roialign（with GAN-KD and cosine attention）   | -<br />ResNet101<br /> | 71.7<br />74.0(+2.3)<br />  |
